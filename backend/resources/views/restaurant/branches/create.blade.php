...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('restaurant.branches.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.1" class="form-control @error('delivery_radius') is-invalid @enderror" id="delivery_radius" name="delivery_radius" value="{{ old('delivery_radius') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('preparation_time') is-invalid @enderror" id="preparation_time" name="preparation_time" value="{{ old('preparation_time') }}">
